...
def _image_name(cam_key: str) -> str:
    return f"{cam_key}.{'png' if SAVE_AS_PNG else 'jpg'}"
...
def analyze_session_dir(session_dir: str | Path) -> Dict[str, Any]:
    ...
    cam2_path = session_dir / _image_name("cam2")
    cam3_path = session_dir / _image_name("cam3")
    cam4_path = session_dir / _image_name("cam4")
