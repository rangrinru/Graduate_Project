...
def analyze_porphyrin_api(profile_id, capture_id):
    try:
        ...
        return jsonify({
            ...
            "risk_z_score": report["risk_z_score"],
            "risk_score_mean": report["risk_score_mean"],
            "risk_score_std": report["risk_score_std"],
            "risk_score_boundaries": report["risk_score_boundaries"],
...
def get_porphyrin_analysis_report_api(profile_id, capture_id):
    try:
        ...
        return jsonify({
            ...
            "risk_z_score": report.get("risk_z_score", 0),
            "risk_score_mean": report.get("risk_score_mean", 0),
            "risk_score_std": report.get("risk_score_std", 0),
            "risk_score_boundaries": report.get("risk_score_boundaries", {}),
